...
10. Now the last bit of code we need to add is a method to submit the extraDataXML Profile update. This method will be called by our "SET" button. Lets add a new method to the MainActivity class.
